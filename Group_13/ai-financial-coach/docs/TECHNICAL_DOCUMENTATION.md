...
## 14. Suggested Final Deliverable Formats

This technical document can later be converted into:
- Google Doc
- PDF
- project wiki page
- GitHub `docs/` site
...
For now, this Markdown file is a good review draft because it is:
- version-controlled
- easy to edit
- easy to copy into Google Docs
- able to render Mermaid diagrams in compatible viewers
