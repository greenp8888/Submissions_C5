            ...
            <nav className="flex flex-wrap gap-2">
              {navigation.map(({ to, label, icon: Icon }) => (
                <NavLink
                  ...
                  className={({ isActive }) =>
                    cn(
                      "inline-flex items-center gap-2 rounded-xl border border-white/60 px-4 py-2 text-sm font-semibold transition",
                      isActive ? "bg-primary text-primary-foreground" : "bg-white/70 text-foreground hover:bg-white",
                    )
                  }
                >
