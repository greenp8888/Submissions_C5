...
def generate_response(user_input):
    ...
    try:
        ...
        # Add conversation history (excluding initial greeting if it's the first message)
        ...
        system_prompt = f"You are a helpful assistant. Respond in a {style.lower()} manner."
