...
{{
  ...
  "suggested_features": [
    {{"feature": "feature name", "rationale": "why this matters", "priority": "high|medium|low"}},
    ...
  ],
...
Be direct. Base every point on the research results provided. Do not invent signals."""
